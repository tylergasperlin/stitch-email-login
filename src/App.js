...
class App extends Component {
    ...
    constructor() {
        super();
        //first need to initalize stitch
        this.client = Stitch.initializeDefaultAppClient('fakeshop-ylyos');
    }
    ...
    authHandler = (event, authData) => {
        ...
        request
            ...
            .catch(err => {
                this.errorHandler('An error occured registering');
                console.log(err);
                this.setState({ isAuth: false });
            });
        //let request;
    ...
    render() {
        let routes = (
            <Switch>
                ...
                <Route
                    path='/product/:mode'
                    render={props => <EditProductPage {...props} onError={this.errorHandler} />}
                />
                <Route
                ...
                <Route
                    path='/products/:id'
                    render={props => <ProductPage {...props} onError={this.errorHandler} />}
                />
                <Route
                    path='/products'
                    render={props => <ProductsPage {...props} onError={this.errorHandler} />}
                />
            </Switch>
        );
